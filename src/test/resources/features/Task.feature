...
#    When The user creates a new task with the following name "Test To Assign"
#      And The user goes to task page
...
#    When the user goes to notifications page
#    Then the user should see the task listed in the notification result
#
