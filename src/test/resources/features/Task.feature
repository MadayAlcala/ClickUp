Feature: Task
  ...
  Scenario: A user creates a new task
    ...
    When The user create a new space with the following name TestSpace
      And The user create a new list with the following name TestList
      And The user create a new task with the following name TestTask
    Then The user should see the success message
      And The user should see the new task appear in the panel successfully
